...
var app = actions_on_google_1.smarthome({
    debug: true,
    jwt: require('./smart-home.json')
});
var transformDeltaState = function (deltaState) {
    var state = {};
...
var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var deviceName, updatedState;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                deviceName = event.thing_id;
                updatedState = transformDeltaState(event.state);
                return [4 /*yield*/, app.reportState({
                        requestId: uuid_1.v4(),
                        agentUserId: '1',
                        payload: {
                            devices: {
                                states: (_a = {},
                                    _a[deviceName] = updatedState,
                                    _a)
                            }
                        }
                    })];
